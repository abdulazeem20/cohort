...
class Mailer
{
    ...
    public function sendMail()
    {
        ...
        try {
            ...
            $mail->Host       = 'klemweb.com';                     //Set the SMTP server to send through
            $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
            $mail->Username   = 'admissions@klemweb.com';                     //SMTP username
            $mail->Password   = 'Klemwebadmission';                               //SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
            $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

            //Recipients
            $mail->setFrom('admissions@klemweb.com', 'Klemweb Cohort Team');
